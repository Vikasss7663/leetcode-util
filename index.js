...
app.get("/send-mail", async (req, res) => {
  try {
    ...
    const streak = streakCount != null ? streakCount.streakCount : 0;
    const currentDayCompleted =
      streakCount != null ? streakCount.currentDayCompleted : 0;
    ...
    const title =
      questionInfo.question.frontendQuestionId +
      ". " +
    ...
    if (hasOfficialSolution) {
      ...
      if (solutionContent != null) {
        ...
        solutionContent = "Solution is not available.";
      }
    }
